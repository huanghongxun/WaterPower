...
//			mGrowthSpeed = aGrowthSpeed>0?aGrowthSpeed:mTier*300;
    ...
    public boolean rightclick(ICropTile aCrop, EntityPlayer aPlayer) {
		...
		if (aPlayer!=null&&GT_Utility.areUnificationsEqual(tContainerItem, aPlayer.getCurrentEquippedItem())&&aPlayer.getCurrentEquippedItem().stackSize>=mDrop.stackSize&&aPlayer.inventory.addItemStackToInventory(GT_Utility.copy(mDrop))) {
