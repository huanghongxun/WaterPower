...
public class GT_OreDictUnificator {
	...
	public static ItemStack get(boolean aUseBlackList, ItemStack aStack) {
		...
		if (aUseBlackList && (GT_Utility.isItemStackInList(aStack, sBlackList) || GT_Utility.getBlockFromStack(aStack) != null || GT_Utility.getFluidForFilledItem(aStack) != null)) return GT_Utility.copy(aStack);
	...
	public static boolean isItemStackInstanceOf(ItemStack aStack, Object aName) {
		...
		for (ItemStack tOreStack : getOres(aName.toString()))
			if (GT_Utility.areUnificationsEqual(tOreStack, aStack, !tOreStack.hasTagCompound()))
				return true;
		return false;
	}
