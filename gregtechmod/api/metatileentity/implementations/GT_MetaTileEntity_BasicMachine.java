...
public abstract class GT_MetaTileEntity_BasicMachine extends MetaTileEntity {
    ...
    private void addOutputProducts() {
    	if (mOutputItem1 != null)
	    	...
	    	else if (GT_Utility.areUnificationsEqual(mInventory[3], mOutputItem1))
	    	...
	    	else if (GT_Utility.areUnificationsEqual(mInventory[4], mOutputItem1))
    	...
    	if (mOutputItem2 != null)
	    	...
	    	else if (GT_Utility.areUnificationsEqual(mInventory[3], mOutputItem2))
	    	...
	    	else if (GT_Utility.areUnificationsEqual(mInventory[4], mOutputItem2))
    ...
    public boolean spaceForOutput(ItemStack aOutput1, ItemStack aOutput2) {
    	if (mInventory[3] == null || aOutput1 == null || (mInventory[3].stackSize + aOutput1.stackSize <= mInventory[3].getMaxStackSize() && GT_Utility.areUnificationsEqual(mInventory[3], aOutput1)))
    	if (mInventory[4] == null || aOutput2 == null || (mInventory[4].stackSize + aOutput2.stackSize <= mInventory[4].getMaxStackSize() && GT_Utility.areUnificationsEqual(mInventory[4], aOutput2)))
    		return true;
    	bOutputBlocked = true;
    	return false;
    }
	...
	public boolean allowPutStack(int aIndex, byte aSide, ItemStack aStack) {
		...
		if (hasTwoSeperateInputs()&&GT_Utility.areUnificationsEqual(aStack, mInventory[aIndex==1?2:1])) return false;
