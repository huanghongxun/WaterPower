...
public class ClientGUIWatermill extends GuiContainer {
	...
	public static ClientGUIWatermill makeGUI(EntityPlayer player,
			TileEntityWatermill gen) {
		return new ClientGUIWatermill(player, gen);
	}
	...
	protected ClientGUIWatermill(EntityPlayer player, TileEntityWatermill gen) {
	...
	protected void drawGuiContainerForegroundLayer(int par1, int par2) {
		...
		fontRenderer.drawString(
			"当前输出: "
				...
				+ "EU/t", 8, 40, 0x404040);
		fontRenderer.drawString("当前检测到的水的数量:" + gen.waterBlocks, 8, 50, 0x404040);
		int a = gen.getType().length;
		int b = a * a * a;
		fontRenderer.drawString("需求:" + b + "=" + a + "^3", 8, 60, 0x404040);
	}
