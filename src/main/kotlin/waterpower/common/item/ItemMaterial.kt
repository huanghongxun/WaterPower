...
class ItemMaterial() : ItemColorable("material") {
    ...
    override fun onItemUseFirst(stack: ItemStack?, player: EntityPlayer, world: World, pos: BlockPos, side: EnumFacing, hitX: Float, hitY: Float, hitZ: Float, hand: EnumHand): EnumActionResult {
