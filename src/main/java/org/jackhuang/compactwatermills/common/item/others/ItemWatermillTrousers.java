...
public class ItemWatermillTrousers extends ItemArmor
	...
	public ItemWatermillTrousers(WaterType type) {
	...
	public void onArmorTick(World world, EntityPlayer player,
		...
		double [] d = Utilities.getBiomeRaining(player.worldObj, (int)player.posX, (int)player.posZ);
		double weather = d[0];
		double biomeGet = d[2];
	...
	public ResourceLocation getRenderTexture() {
		return new ResourceLocation(Reference.ModID + ":textures/items/armor/"
			+ "itemArmorLegs");
	}
}
