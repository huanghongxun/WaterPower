...
public class PacketDispatcher {
	...
	public static void sendToServer(CompactWatermillsPacket packet) {
		PacketHandler.INSTANCE.channel.sendToServer(packet.getPacket());
	}

	public static void sendToPlayer(CompactWatermillsPacket packet,
			EntityPlayerMP player) {
		PacketHandler.INSTANCE.channel.sendTo(packet.getPacket(), player);
	}

	public static void sendToAll(CompactWatermillsPacket packet) {
		PacketHandler.INSTANCE.channel.sendToAll(packet.getPacket());
	}

	public static void sendToAllAround(CompactWatermillsPacket packet,
			NetworkRegistry.TargetPoint zone) {
		PacketHandler.INSTANCE.channel
				.sendToAllAround(packet.getPacket(), zone);
	}

	public static void sendToDimension(CompactWatermillsPacket packet,
			int dimensionId) {
	...
	public static void sendToWatchers(CompactWatermillsPacket packet,
