...
public class Machines {
    ...
    public static void addCrusherRecipe(@NotNull IItemStack input,
        ...
        MineTweakerAPI.apply(new MyRecipeManagerAction("WaterPower Crusher",
    ...
    public static void addLatheRecipe(@NotNull IItemStack input,
            @NotNull IItemStack output) {
        MineTweakerAPI.apply(new MyRecipeManagerAction("WaterPower Lathe",
    ...
    public static void addCutterRecipe(@NotNull IItemStack input,
            @NotNull IItemStack output) {
        MineTweakerAPI.apply(new MyRecipeManagerAction("WaterPower Cutter",
    ...
    public static void addCompressorRecipe(@NotNull IItemStack input,
            @NotNull IItemStack output) {
        MineTweakerAPI.apply(new MyRecipeManagerAction("WaterPower Compressor",
    ...
    public static void addCentrifugeRecipe(@NotNull IItemStack input,
            @NotNull IItemStack output) {
        MineTweakerAPI.apply(new MyRecipeManagerAction("WaterPower Centrifuge",
                MyRecipes.centrifuge, MineTweakerMC.getItemStack(input),
                MineTweakerMC.getItemStack(output)));
    }

    @ZenMethod
    public static void addAdvancedCompress0rRecipe(@NotNull IItemStack input,
            @NotNull IItemStack output) {
        MineTweakerAPI.apply(new MyRecipeManagerAction("WaterPower Advanced Compressor",
    ...
    public static void addSawmillRecipe(@NotNull IItemStack input,
            @NotNull IItemStack output) {
        MineTweakerAPI.apply(new MyRecipeManagerAction("WaterPower Sawmill",
