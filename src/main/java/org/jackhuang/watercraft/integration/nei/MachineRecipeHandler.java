...
public abstract class MachineRecipeHandler extends TemplateRecipeHandler {
    ...
    public void loadTransferRects() {
        this.transferRects.add(new TemplateRecipeHandler.RecipeTransferRect(new Rectangle(43, 23, 25, 16), getRecipeId()));
    ...
    public void loadCraftingRecipes(String outputId, Object... results) {
        if (outputId.equals(getRecipeId())) {
            for (Map.Entry<IMyRecipeInput, MyRecipeOutput> entry : getRecipeList().getAllRecipes().entrySet())
    ...
    public class CachedIORecipe extends TemplateRecipeHandler.CachedRecipe {
        ...
        public CachedIORecipe(ItemStack input, ItemStack output1) {
            ...
            this.ingredients.add(new PositionedStack(input, MachineRecipeHandler.this.getInputPosX(), MachineRecipeHandler.this.getInputPosY()));
            this.output = new PositionedStack(output1, MachineRecipeHandler.this.getOutputPosX(), MachineRecipeHandler.this.getOutputPosY());
        }
        ...
        public CachedIORecipe(IMyRecipeInput input, MyRecipeOutput output1) {
            ...
            this.ingredients.add(new PositionedStack(items, MachineRecipeHandler.this.getInputPosX(), MachineRecipeHandler.this.getInputPosY()));
            this.output = new PositionedStack(output1.items.get(0), MachineRecipeHandler.this.getOutputPosX(), MachineRecipeHandler.this.getOutputPosY());
