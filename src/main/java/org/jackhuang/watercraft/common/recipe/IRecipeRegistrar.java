...
public abstract class IRecipeRegistrar {
    ...
    private void addPaddleBaseRecipe(LevelTypes level) {
        this.addRecipeByOreDictionary(ItemCrafting.get(CraftingTypes.paddleBase, level), "W W", "SAS", 'W',
    ...
    void registerBaseMaterialRecipes() {
        ...
        if (Mods.IndustrialCraft2.isAvailable) {
            flag = 1;
            this.addRecipeByOreDictionary(ItemCrafting.get(outputInterface, LevelTypes.MK1), "GW", " G", "GW", 'G', ICItemFinder.getIC2Item("goldCableItem"),
                    'W', "plankWood");
        ...
        if (Mods.Mekanism.isAvailable) {
            ...
            this.addShapelessRecipeByOreDictionary(ItemCrafting.get(circuit, MK1), ItemType.WaterResistantRubber.item(),
        ...
        this.addRecipeByOreDictionary(ItemCrafting.get(CraftingTypes.rotationAxle, MK1), "SBS", "SHS", "SBS", 'S', Items.stick, 'B', "plankWood", 'H',
        ...
        if (Mods.IndustrialCraft2.isAvailable) {
            this.addRecipeByOreDictionary(ItemCrafting.get(drainagePlate, MK3), "WW", "AW", "KW", 'W', "plateZincAlloy", 'A',
                    ICItemFinder.getIC2Item("ironScaffold"), 'K', "screwZinc");
        } else {
            this.addRecipeByOreDictionary(ItemCrafting.get(drainagePlate, MK3), "WW", "AW", "KW", 'W', "plateZincAlloy", 'A', "stickZincAlloy", 'K',
                    "screwZinc");
        }
        if (gregtechRecipe) {
        ...
        this.addRecipeByOreDictionary(ItemCrafting.get(rotationAxle, LevelTypes.MK3), "GPG", "ICI", "GPG", 'G', "gearZincAlloy", 'P', "plateZincAlloy", 'I',
                "plateIron", 'C', ItemCrafting.get(casing, LevelTypes.MK3));
        this.addRecipeByOreDictionary(ItemCrafting.get(rotationAxle, LevelTypes.MK3), "GPG", "ICI", "GPG", 'G', "gearZincAlloy", 'P', "plateZincAlloy", 'I',
                "plateSteel", 'C', ItemCrafting.get(casing, LevelTypes.MK3));
        this.addRecipeByOreDictionary(ItemCrafting.get(circuit, LevelTypes.MK3), "PPP", "CDC", "PPP", 'P', ItemType.WaterResistantRubberDensePlate.item(), 'C',
        ...
        this.addRecipeByOreDictionary(ItemCrafting.get(stator, LevelTypes.MK3), "PIS", "PI ", "PIS", 'P', "plateZincAlloy", 'I', "dustMagnet", 'S',
                "stickZincAlloy");
        flag = 0;

        if (Mods.IndustrialCraft2.isAvailable) {
            flag = 1;
            this.addRecipeByOreDictionary(ItemCrafting.get(rotor, LevelTypes.MK3), "CIC", "GIG", "G G", 'G', ICItemFinder.getIC2Item("goldCableItem"), 'C',
                    ItemType.DenseCoil.item(), 'I', "ingotIron");
        }

        if (Mods.Mekanism.isAvailable) {
            flag = 1;
            this.addRecipeByOreDictionary(ItemCrafting.get(rotor, LevelTypes.MK3), "CIC", "GIG", "G G", 'G', goldCable, 'C', ItemType.DenseCoil.item(), 'I',
                    "ingotIron");
        }

        if (flag == 0) {
            this.addRecipeByOreDictionary(ItemCrafting.get(rotor, LevelTypes.MK3), "CIC", " I ", " G ", 'G', "ingotGold", 'C', ItemType.DenseCoil.item(), 'I',
                    "ingotIron");
        }

        if (Mods.IndustrialCraft2.isAvailable) {
            this.addRecipeByOreDictionary(ItemCrafting.get(outputInterface, LevelTypes.MK3), "PRB", "RAI", "PRB", 'P', "plateZincAlloy", 'R', "plateRubber",
                    'I', "ingotZincAlloy", 'A', ICItemFinder.getIC2Item("lvTransformer"), 'B', ICItemFinder.getIC2Item("reBattery"));
        } else {
            this.addRecipeByOreDictionary(ItemCrafting.get(outputInterface, LevelTypes.MK3), "PRB", "RAI", "PRB", 'P', "plateZincAlloy", 'R', "plateRubber",
        ...
        this.addRecipeByOreDictionary(ItemCrafting.get(CraftingTypes.drainagePlate, LevelTypes.MK4), "WW", "KW", "KW", 'W', "plateIndustrialSteel", 'K',
                "blockIndustrialSteel");
        this.addRecipeByOreDictionary(ItemCrafting.get(CraftingTypes.fixedFrame, LevelTypes.MK4), "P  ", "DP ", "SDP", 'P', "plateIndustrialSteel", 'D',
        ...
        if (gregtechRecipe) {
            GregTech_API.sRecipeAdder.addAssemblerRecipe(ItemMaterial.get(MaterialTypes.IndustrialSteel, MaterialForms.plateDense),
                    ItemMaterial.get(MaterialTypes.IndustrialSteel, MaterialForms.ingot), ItemCrafting.get(CraftingTypes.fixedTool, LevelTypes.MK4), 6000, 5);
        } else {
            this.addShapelessRecipeByOreDictionary(ItemCrafting.get(CraftingTypes.fixedTool, LevelTypes.MK4), "plateDenseIndustrialSteel",
                    "ingotIndustrialSteel");
        }
        if (Mods.IndustrialCraft2.isAvailable) {
            this.addRecipeByOreDictionary(ItemCrafting.get(CraftingTypes.outputInterface, LevelTypes.MK4), "SSP", "PTB", "SSP", 'S', "blockSilver", 'P',
                    "plateIndustrialSteel", 'T', ICItemFinder.getIC2Item("mvTransformer"), 'B', ICItemFinder.getIC2Item("suBattery"));
            this.addRecipeByOreDictionary(ItemCrafting.get(CraftingTypes.outputInterface, LevelTypes.MK4), "SSP", "PTB", "SSP", 'S', "blockNeodymium", 'P',
                    "plateIndustrialSteel", 'T', ICItemFinder.getIC2Item("mvTransformer"), 'B', ICItemFinder.getIC2Item("suBattery"));
        } else {
            this.addRecipeByOreDictionary(ItemCrafting.get(CraftingTypes.outputInterface, LevelTypes.MK4), "SSP", "PTB", "SSP", 'S', "blockSilver", 'P',
        ...
        this.addRecipeByOreDictionary(ItemCrafting.get(CraftingTypes.rotationAxle, LevelTypes.MK4), "GPG", "ICI", "GPG", 'G', "gearIndustrialSteel", 'P',
        ...
        this.addRecipeByOreDictionary(ItemCrafting.get(CraftingTypes.circuit, LevelTypes.MK4), "PPP", "CDC", "BPB", 'P', ItemType.DenseRedstonePlate.item(),
        ...
        this.addRecipeByOreDictionary(ItemCrafting.get(CraftingTypes.stator, LevelTypes.MK4), "PP", "PB", "PP", 'P', "plateIndustrialSteel", 'B',
                "blockNeodymiumMagnet");
        this.addRecipeByOreDictionary(ItemCrafting.get(CraftingTypes.rotor, LevelTypes.MK4), "SPS", "PBP", "SPS", 'S', ItemType.DenseSilverCoil.item(), 'P',
        ...
        this.addRecipeByOreDictionary(ItemCrafting.get(CraftingTypes.drainagePlate, LevelTypes.MK5), "WW", "KW", "KW", 'W', "plateManganeseSteel", 'K',
                "blockManganeseSteel");
        if (Mods.IndustrialCraft2.isAvailable) {
            this.addRecipeByOreDictionary(ItemCrafting.get(CraftingTypes.circuit, LevelTypes.MK5), "PDP", "DCD", "PDP", 'P',
                    ItemType.WaterResistantRubberDensePlate.item(), 'C', getUsualItemStack(ICItemFinder.getIC2Item("energyCrystal")), 'D',
                    ItemType.DataBall.item());
        } else {
            this.addRecipeByOreDictionary(ItemCrafting.get(CraftingTypes.circuit, LevelTypes.MK5), "PDP", "DCD", "PDP", 'P',
                    ItemType.WaterResistantRubberDensePlate.item(), 'C', "gemDiamond", 'D', ItemType.DataBall.item());
        }
        this.addRecipeByOreDictionary(ItemCrafting.get(CraftingTypes.fixedFrame, LevelTypes.MK5), "P  ", "DP ", "SDP", 'P', "plateManganeseSteel", 'D',
                "plateDenseManganeseSteel", 'S', "screwManganeseSteel");
        if (gregtechRecipe) {
            GregTech_API.sRecipeAdder.addAssemblerRecipe(ItemMaterial.get(MaterialTypes.ManganeseSteel, MaterialForms.plateDense),
                    ItemMaterial.get(MaterialTypes.ManganeseSteel, MaterialForms.ingot), ItemCrafting.get(CraftingTypes.fixedTool, LevelTypes.MK5), 6000, 5);
        } else {
        ...
        this.addRecipeByOreDictionary(ItemCrafting.get(CraftingTypes.stator, LevelTypes.MK5), "PP", "PB", "PP", 'P', "plateManganeseSteel", 'B',
                "blockNeodymiumMagnet");

        if (Mods.IndustrialCraft2.isAvailable) {
            this.addRecipeByOreDictionary(ItemCrafting.get(CraftingTypes.outputInterface, LevelTypes.MK5), "SSP", "PTB", "SSP", 'S', "blockNeodymiumMagnet",
                    'P', "plateManganeseSteel", 'T', ICItemFinder.getIC2Item("hvTransformer"), 'B', ICItemFinder.getIC2Item("suBattery"));
        } else {
            this.addRecipeByOreDictionary(ItemCrafting.get(CraftingTypes.outputInterface, LevelTypes.MK5), "SSP", "PTB", "SSP", 'S', "blockNeodymiumMagnet",
                    'P', "plateManganeseSteel", 'T', "blockManganese", 'B', "dustRedstone");
        }
        this.addRecipeByOreDictionary(ItemCrafting.get(CraftingTypes.rotationAxle, LevelTypes.MK5), "GPG", "ICI", "GPG", 'G', "gearManganeseSteel", 'P',
        ...
        this.addRecipeByOreDictionary(ItemCrafting.get(CraftingTypes.rotor, LevelTypes.MK5), "SPS", "PBP", "SPS", 'S', ItemType.DenseSilverCoil.item(), 'P',
        ...
        this.addRecipeByOreDictionary(ItemCrafting.get(CraftingTypes.drainagePlate, LevelTypes.MK7), "WW", "KW", "KW", 'W', "plateVanadiumSteel", 'K',
                "blockVanadiumSteel");
        if (Mods.IndustrialCraft2.isAvailable) {
            this.addRecipeByOreDictionary(ItemCrafting.get(CraftingTypes.circuit, LevelTypes.MK7), "PDP", "DCD", "PDP", 'P',
                    ItemType.WaterResistantRubberDensePlate.item(), 'C', getUsualItemStack(ICItemFinder.getIC2Item("lapotronCrystal")), 'D',
                    ItemType.DataBall.item());
        } else {
            this.addRecipeByOreDictionary(ItemCrafting.get(CraftingTypes.circuit, LevelTypes.MK7), "PDP", "DCD", "PDP", 'P',
                    ItemType.WaterResistantRubberDensePlate.item(), 'C', "blockDiamond", 'D', ItemType.DataBall.item());
        }
        this.addRecipeByOreDictionary(ItemCrafting.get(CraftingTypes.fixedFrame, LevelTypes.MK7), "P  ", "DP ", "SDP", 'P', "plateVanadiumSteel", 'D',
        ...
        this.addRecipeByOreDictionary(ItemCrafting.get(CraftingTypes.stator, LevelTypes.MK7), "PP", "PB", "PP", 'P', "plateVanadiumSteel", 'B',
                "blockNeodymiumMagnet");

        this.addRecipeByOreDictionary(ItemCrafting.get(CraftingTypes.outputInterface, LevelTypes.MK7), "SSP", "PTB", "SSP", 'S', "blockNeodymiumMagnet", 'P',
                "plateVanadiumSteel", 'T', "blockVanadium", 'B', "dustRedstone");
        this.addRecipeByOreDictionary(ItemCrafting.get(CraftingTypes.rotationAxle, LevelTypes.MK7), "GPG", "ICI", "GPG", 'G', "gearVanadiumSteel", 'P',
        ...
        this.addRecipeByOreDictionary(ItemCrafting.get(CraftingTypes.rotor, LevelTypes.MK7), "SPS", "PBP", "SPS", 'S', ItemType.DenseSilverCoil.item(), 'P',
        ...
        if (gregtechRecipe) {
            ...
            GregTech_API.sRecipeAdder.addBlastRecipe(ICItemFinder.getIC2Item("carbonMesh"), null, ItemType.HighPurityCarbonDust.item(), null, 240 * 20, 512,
                    3000);
        } else {
            flag = 0;
            if (Mods.IndustrialCraft2.isAvailable) {
