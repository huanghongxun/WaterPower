...
public class EasyRecipeRegistrar extends IRecipeRegistrar {
	...
	public void registerRange() {
		if (gregtechRecipe) {
			...
			addRecipeByOreDictionary(
					...
					'W',
					getUsualItemStack(ICItemFinder.getIC2Item("energyCrystal")),
					'S', ICItemFinder.getIC2Item("mfeUnit"), 'A',
			...
			addRecipeByOreDictionary(new ItemStack(GlobalItems.range, 1, 3),
					...
					ICItemFinder.getIC2Item("mfsUnit"), 'A', new ItemStack(
	...
	public void registerUpdater() {
		...
		addRecipeByOreDictionary(ItemType.MK1.item(), "SMS", "UGU", "SAS", 'S',
				Item.redstone, 'U', ItemType.WaterUraniumPlateMK1.item(), 'A',
		...
		addRecipeByOreDictionary(ItemType.MK2.item(), "SMS", "UGU", "SAS", 'S',
				...
				carbonPlate, 'M', Block.blockLapis, 'G', ItemType.MK1.item());
		...
		if (Mods.IndustrialCraft2.isAvailable) {
			addRecipeByOreDictionary(ItemType.MK4.item(), "SMS", "UGU", "SAS",
					'S', ICItemFinder.getIC2Item("advancedAlloy"), 'U',
					ItemType.WaterUraniumPlateMK4.item(), 'A',
					getUsualItemStack(ICItemFinder.getIC2Item("advBattery")),
					'M', Block.blockEmerald, 'G', ItemType.MK3.item());
			addRecipeByOreDictionary(
					ItemType.MK5.item(),
					"SMS",
					"UGU",
					...
					'U',
					ItemType.WaterUraniumPlateMK5.item(),
					'A',
					getUsualItemStack(ICItemFinder.getIC2Item("energyCrystal")),
					'M', doesOreNameExist("blockRuby") ? "blockRuby"
							: "blockManganeseSteel", 'G', ItemType.MK4.item());
			addRecipeByOreDictionary(ItemType.MK6.item(), "SMS", "UGU", "SAS",
					'S', advancedAlloy, 'U',
					ItemType.WaterUraniumPlateMK6.item(), 'A',
					getUsualItemStack(ICItemFinder
							.getIC2Item("lapotronCrystal")), 'M',
					doesOreNameExist("blockSapphire") ? "blockSapphire"
							: "blockVanadium", 'G', ItemType.MK5.item());
			addRecipeByOreDictionary(ItemType.MK7.item(), "SMS", "UGU", "SAS",
					'S', ICItemFinder.getIC2Item("advancedAlloy"), 'U',
					ItemType.WaterUraniumPlateMK7.item(), 'A',
					getUsualItemStack(ICItemFinder.getIC2Item("suBattery")),
					'M', doesOreNameExist("blockChrome") ? "blockChrome"
		...
		RecipeAdder.macerator(new ItemStack(Block.cactus, 1, 16),
		...
		if (!Mods.IndustrialCraft2.isAvailable) {
			RecipeAdder.macerator(new ItemStack(Item.diamond),
					ItemType.DustDiamond.item());
			RecipeAdder.macerator(new ItemStack(Block.oreIron),
					ItemType.DustIron.item(2));
			RecipeAdder.macerator(new ItemStack(Block.oreGold),
					ItemType.DustGold.item(2));
			RecipeAdder.macerator(new ItemStack(Item.ingotIron),
					ItemType.DustIron.item());
			RecipeAdder.macerator(new ItemStack(Item.ingotGold),
					ItemType.DustGold.item());
			addSmelting(ItemType.DustIron.item(), new ItemStack(Item.ingotIron));
			addSmelting(ItemType.DustGold.item(), new ItemStack(Item.ingotGold));
		}

		OreDictionary.registerOre("plateDenseRedstone",
				ItemType.DenseRedstonePlate.item());
		RecipeAdder.compressor(new ItemStack(Block.blockRedstone),
				ItemType.DenseRedstonePlate.item());
	}
	...
	public void registerTurbine() {
		...
		addRecipeByOreDictionary(new ItemStack(GlobalBlocks.turbine, 1, 0),
				"SAU", "CGA", "SAU", 'S', Block.fence, 'A', new ItemStack(
		...
		addRecipeByOreDictionary(new ItemStack(GlobalBlocks.turbine, 1, 3),
				"IRI", "TCT", "IRI", 'T', new ItemStack(GlobalBlocks.turbine,
						1, 2), 'I', ICItemFinder.getIC2Item("reactorPlating"),
				'C', ICItemFinder.getIC2Item("teleporter"), 'R',
				ItemType.BaseRotor.item());
		// }
	...
	public void registerMachines() {
		addRecipeByOreDictionary(GlobalBlocks.sawmill, " H ", "CPC", "KKK",
				...
				Block.stoneBrick, 'P', ItemType.DiamondBlade.item());
		addRecipeByOreDictionary(GlobalBlocks.sawmill, " H ", "CPC", "KKK",
				'H', ItemType.WoodenHammer.item(), 'C',
				ItemCrafting.get(CraftingTypes.casing, LevelTypes.MK1), 'K',
				Block.stoneBrick, 'P', Item.flint);
		addRecipeByOreDictionary(GlobalBlocks.macerator, " H ", "CPC", "KRK",
				'H', ItemType.WoodenHammer.item(), 'C',
				ItemCrafting.get(CraftingTypes.casing, LevelTypes.MK1), 'K',
				Block.stoneBrick, 'P', ItemType.DiamondGlazingWheel.item(),
				'R', Block.hopperBlock);
		addRecipeByOreDictionary(GlobalBlocks.macerator, " H ", "CPC", "KRK",
				'H', ItemType.WoodenHammer.item(), 'C',
				ItemCrafting.get(CraftingTypes.casing, LevelTypes.MK1), 'K',
				Block.stoneBrick, 'P', Item.flint, 'R', Block.hopperBlock);
	...
	public void registerPlugins() {
		...
		addShapelessRecipeByOreDictionary(PluginType.StorageMK1.item(),
				new ItemStack(GlobalBlocks.reservoir, 1, 8), Item.ingotIron,
				Item.ingotIron, Item.ingotIron);
		addShapelessRecipeByOreDictionary(PluginType.StorageMK2.item(),
				new ItemStack(GlobalBlocks.reservoir, 1, 17),
				PluginType.StorageMK1.item(), Item.ingotIron,
				Item.ingotIron, Item.ingotIron);
		addShapelessRecipeByOreDictionary(PluginType.SpeedMK1.item(),
				ItemType.DataBall.item(), Item.ingotIron, Item.ingotIron,
				Item.ingotIron);
		...
		if (Mods.IndustrialCraft2.isAvailable) {
			...
			addRecipeByOreDictionary(PluginType.OverMK1.item(), "CBC", "EPE",
					"CBC", 'C', "ringVanadiumSteel", 'B',
					ICItemFinder.getIC2Item("pump"), 'E', extractor, 'P',
					ItemType.VSteelWaterPipe.item());
		}
		if (Mods.BuildCraftFactory.isAvailable) {
			addRecipeByOreDictionary(PluginType.OverMK1.item(), "CBC", "EPE",
					"CBC", 'C', "ringVanadiumSteel", 'B',
					GameRegistry.findBlock("BuildCraft|Factory", "pumpBlock"),
					'E', ItemType.RubyWaterHole.item(), 'P',
					ItemType.VSteelWaterPipe.item());
		}
		if (!Mods.IndustrialCraft2.isAvailable
				&& !Mods.BuildCraftFactory.isAvailable)
			addRecipeByOreDictionary(PluginType.OverMK1.item(), "CBC", "EPE",
					"CBC", 'C', "ringVanadiumSteel", 'B', "gearVanadiumSteel",
					'E', ItemType.RubyWaterHole.item(), 'P',
					ItemType.VSteelWaterPipe.item());
		...
		addRecipeByOreDictionary(PluginType.RainMK1.item(), "C C", "EPE",
				"C C", 'C', "ringVanadiumSteel", 'E', extractor, 'P',
				ItemType.VSteelWaterPipe.item());
	}
