...
public class EasyRecipeRegistrar extends IRecipeRegistrar {
    ...
    public void registerWatermills() {
        addRecipeByOreDictionary(new ItemStack(GlobalBlocks.waterMill, 1, 0),
                "CUC", "SAS", "PMP", 'C',
                IndustrialCraftModule.getIC2Item("FluidCell"), 'A',
                "blockIron", 'S', "plateIron", 'P', electronicCircuit, 'M',
                ItemType.MK0.item(), 'U', ItemType.WaterUraniumIngot.item());

        addRecipeByOreDictionary(new ItemStack(GlobalBlocks.waterMill, 1, 1),
                "CUC", "SAS", "PMP", 'C',
                IndustrialCraftModule.getIC2Item("FluidCell"), 'A',
                new ItemStack(GlobalBlocks.waterMill, 1, 0), 'S', "plateIron",
                'P', advancedCircuit, 'M', ItemType.MK0.item(), 'U',
                ItemType.WaterUraniumIngot.item());

        addRecipeByOreDictionary(new ItemStack(GlobalBlocks.waterMill, 1, 3),
                "CUC", "SAS", "PMP", 'C',
                IndustrialCraftModule.getIC2Item("FluidCell"), 'A',
                new ItemStack(GlobalBlocks.waterMill, 1, 1), 'S', carbonPlate,
                'P', advancedCircuit, 'M', ItemType.MK1.item(), 'U',
        ...
        addRecipeByOreDictionary(new ItemStack(GlobalBlocks.waterMill, 1, 5),
                ...
                IndustrialCraftModule.getIC2Item("elemotor"), 'P',
                advancedCircuit, 'M', ItemType.MK2.item(), 'U',
        ...
        addRecipeByOreDictionary(new ItemStack(GlobalBlocks.waterMill, 1, 6),
                ...
                getUsualItemStack(IndustrialCraftModule
                        .getIC2Item("lapotronCrystal")), 'P', advancedCircuit,
                'M', ItemType.MK3.item(), 'U',
    ...
    public void registerRange() {
        if (gregtechRecipe) {
            addRecipeByOreDictionary(new ItemStack(GlobalItems.range, 1, 0),
                    ...
                    getUsualItemStack(IndustrialCraftModule
                            .getIC2Item("energyCrystal")), 'A', machine);
            ...
            addRecipeByOreDictionary(new ItemStack(GlobalItems.range, 1, 2),
                    "WSW", "SAS", "WSW", 'W',
                    getUsualItemStack(IndustrialCraftModule
                            .getIC2Item("energyCrystal")), 'S',
                    IndustrialCraftModule.getIC2Item("mfeUnit"), 'A',
                    new ItemStack(GlobalItems.range, 1, 1));
            addRecipeByOreDictionary(new ItemStack(GlobalItems.range, 1, 3),
                    "WSW", "SAS", "WSW", 'W',
                    getUsualItemStack(IndustrialCraftModule
                            .getIC2Item("lapotronCrystal")), 'S',
                    IndustrialCraftModule.getIC2Item("mfsUnit"), 'A',
                    new ItemStack(GlobalItems.range, 1, 2));
        } else {
            addRecipeByOreDictionary(new ItemStack(GlobalItems.range, 1, 0),
                    "WSW", "SAS", "WSW", 'W', electronicCircuit, 'S',
                    IndustrialCraftModule.getIC2Item("batBox"), 'A', machine);
            addRecipeByOreDictionary(new ItemStack(GlobalItems.range, 1, 1),
                    "WSW", "SAS", "WSW", 'W', advancedCircuit, 'S',
                    IndustrialCraftModule.getIC2Item("cesuUnit"), 'A',
                    new ItemStack(GlobalItems.range, 1, 0));
            addRecipeByOreDictionary(new ItemStack(GlobalItems.range, 1, 2),
                    "WSW", "SAS", "WSW", 'W',
                    getUsualItemStack(IndustrialCraftModule
    ...
    public void registerUpdater() {
        ...
        if (Mods.IndustrialCraft2.isAvailable)
            addRecipeByOreDictionary(is, "SAS", "ASA", "SAS", 'A',
                    "blockUranium", 'S',
                    IndustrialCraftModule.getIC2Item("reactorCoolantSix"));
        else
            ...
            if (Mods.Railcraft.isAvailable)
                for (ItemStack sasasasa : OreDictionary.getOres("ingotUranium"))
                    RailcraftModule.addRollingMachineRecipe(is2, "SAS", "ASA",
                            "SAS", 'A', sasasasa, 'S', IndustrialCraftModule
                                    .getIC2Item("electrolyzedWaterCell"));
            else
        ...
        addRecipeByOreDictionary(ItemType.WaterUraniumPlateMK1.item(), "SSS",
                "SAS", "SSS", 'A', ItemType.WaterUraniumIngot.item(), 'S',
                "plateBronze");
        addRecipeByOreDictionary(ItemType.WaterUraniumPlateMK2.item(), "SSS",
                "SAS", "SSS", 'A', ItemType.WaterUraniumPlateMK1.item(), 'S',
                carbonPlate);

        addRecipeByOreDictionary(ItemType.WaterUraniumPlateMK3.item(), "SSS",
                "SAS", "SSS", 'A', ItemType.WaterUraniumPlateMK2.item(), 'S',
                advancedAlloy);

        if (Mods.IndustrialCraft2.isAvailable)
            addRecipeByOreDictionary(ItemType.WaterUraniumPlateMK4.item(),
                    "SSS", "SAS", "SSS", 'A',
                    ItemType.WaterUraniumPlateMK3.item(), 'S', "plateTungsten");
        else
            addRecipeByOreDictionary(ItemType.WaterUraniumPlateMK4.item(),
                    "SSS", "SAS", "SSS", 'A',
                    ItemType.WaterUraniumPlateMK3.item(), 'S',
                    "plateIndustrialSteel");
        if (OreDictionary.doesOreNameExist("plateStainlessSteel"))
            ...
            addRecipeByOreDictionary(ItemType.WaterUraniumPlateMK5.item(),
                    ...
                    ItemType.WaterUraniumPlateMK4.item(), 'S',
                    "plateManganeseSteel");
        if (OreDictionary.doesOreNameExist("plateTungstenSteel"))
        ...
        if (Mods.IndustrialCraft2.isAvailable)
            addRecipeByOreDictionary(ItemType.WaterUraniumPlateMK7.item(),
                    ...
                    IndustrialCraftModule.getIC2Item("iridiumPlate"));
        else
            addRecipeByOreDictionary(ItemType.WaterUraniumPlateMK7.item(),
                    "SSS", "SAS", "SSS", 'A',
                    ItemType.WaterUraniumPlateMK6.item(), 'S',
        ...
        addRecipeByOreDictionary(ItemType.MK0.item(), "SAS", "AGA", "SAS", 'S',
                advancedAlloy, 'A', ItemType.WaterUraniumPlateMK1.item(), 'G',
                transformerUpgrade);
        addRecipeByOreDictionary(ItemType.MK1.item(), "SMS", "UGU", "SAS", 'S',
                Items.redstone, 'U', ItemType.WaterUraniumPlateMK1.item(), 'A',
                "gemDiamond", 'M', "plateSteel", 'G', ItemType.MK0.item());
        addRecipeByOreDictionary(ItemType.MK2.item(), "SMS", "UGU", "SAS", 'S',
                advancedAlloy, 'U', ItemType.WaterUraniumPlateMK2.item(), 'A',
                carbonPlate, 'M', Blocks.lapis_block, 'G', ItemType.MK1.item());
        addRecipeByOreDictionary(ItemType.MK3.item(), "SMS", "UGU", "SAS", 'S',
                advancedAlloy, 'U', ItemType.WaterUraniumPlateMK3.item(), 'A',
                industrialDiamond, 'M', "gemDiamond", 'G', ItemType.MK2.item());
        addRecipeByOreDictionary(ItemType.IR_FE.item(), "SSS", "SGS", "SSS",
                'S', iron, 'G', iridiumPlate);
        if (Mods.IndustrialCraft2.isAvailable) {
            addRecipeByOreDictionary(ItemType.MK4.item(), "SMS", "UGU", "SAS",
                    'S', IndustrialCraftModule.getIC2Item("advancedAlloy"),
                    'U', ItemType.WaterUraniumPlateMK4.item(), 'A',
                    getUsualItemStack(IndustrialCraftModule
                            .getIC2Item("advBattery")), 'M',
                    Blocks.emerald_block, 'G', ItemType.MK3.item());
            addRecipeByOreDictionary(ItemType.MK5.item(), "SMS", "UGU", "SAS",
                    'S', IndustrialCraftModule.getIC2Item("advancedAlloy"),
                    'U', ItemType.WaterUraniumPlateMK5.item(), 'A',
                    getUsualItemStack(IndustrialCraftModule
                            .getIC2Item("energyCrystal")), 'M',
            ...
            addRecipeByOreDictionary(
                    ...
                    advancedAlloy,
                    'U',
                    ItemType.WaterUraniumPlateMK6.item(),
                    'A',
                    getUsualItemStack(IndustrialCraftModule
            ...
            addRecipeByOreDictionary(
                    ...
                    "SAS",
                    'S',
                    IndustrialCraftModule.getIC2Item("advancedAlloy"),
                    'U',
                    ItemType.WaterUraniumPlateMK7.item(),
                    'A',
                    getUsualItemStack(IndustrialCraftModule
            ...
            addRecipeByOreDictionary(ItemType.MK4.item(), "SMS", "UGU", "SAS",
                    ...
                    "stickManganese", 'M', "blockEmerald", 'G',
                    ItemType.MK3.item());
            addRecipeByOreDictionary(ItemType.MK5.item(), "SMS", "UGU", "SAS",
                    'S', "plateSteel", 'U',
        ...
        if (Mods.IndustrialCraft2.isAvailable) {
            addRecipeByOreDictionary(ItemType.ReservoirCoreAdvanced.item(),
                    "IDI", "AMA", "IDI", 'I', iridiumPlate, 'A',
                    IndustrialCraftModule.getIC2Item("advancedCircuit"), 'M',
                    ItemType.ReservoirCore.item(), 'D', "gemDiamond");
        }
        addRecipeByOreDictionary(ItemType.ReservoirCore.item(), "RPR", "PCP",
                "RPR", 'R', "stickZinc", 'P', "plateZinc", 'C', "gearZinc");
        addRecipeByOreDictionary(ItemType.ReservoirCoreAdvanced.item(), "RPR",
                "PCP", "RPR", 'R', "stickVanadiumSteel", 'P',
                "plateVanadiumSteel", 'C', "gearVanadiumSteel");

        addRecipeByOreDictionary(ItemType.WaterUraniumAlloyPlate.item(), "UIU",
                "IDI", "UIU", 'U', ItemType.WaterUraniumIngot.item(), 'I',
                iridiumPlate, 'D', "gemDiamond");
        ...
        addRecipeByOreDictionary(ItemType.DiamondBlade.item(), "ITI", "TDT",
                "ITI", 'I', "plateIron", 'D', "gemDiamond", 'T', "dustDiamond");
        addRecipeByOreDictionary(ItemType.DiamondGlazingWheel.item(), "SSS",
                "SAS", "SSS", 'S', Items.flint, 'A',
                ItemType.DiamondBlade.item());
        addRecipeByOreDictionary(
                ItemType.IndustrialSteelHydraulicCylinder.item(), "PCP", "CBC",
                " I ", 'P', "plateIndustrialSteel", 'C',
                ItemCrafting.get(CraftingTypes.casing, LevelTypes.MK4), 'B',
                "blockIndustrialSteel", 'I', "ingotIndustrialSteel");
        addRecipeByOreDictionary(ItemType.BrassCentrifugePot.item(), "P P",
                "P P", "PDP", 'P', "plateZincAlloy", 'D', "plateDenseZincAlloy");
        addRecipeByOreDictionary(ItemType.BrassCentrifugePot.item(), "P P",
                "P P", "PDP", 'P', "plateZincAlloy", 'D', "plateDenseZincAlloy");
        addRecipeByOreDictionary(ItemType.VSteelPistonCylinder.item(), "PCP",
                "DBD", "PPP", 'P', "plateVanadiumSteel", 'C',
                GlobalBlocks.compressor, 'D', "plateDenseVanadiumSteel", 'B',
                "blockVanadiumSteel");
        addRecipeByOreDictionary(ItemType.VSteelWaterPipe.item(), "DDD", "D D",
                "DDD", 'D', "plateVanadium");
        addRecipeByOreDictionary(ItemType.RubyWaterHole.item(), "IBI", "B B",
                "IBI", 'B', "blockRuby", 'I', "plateVanadium");
        addRecipeByOreDictionary(ItemType.RubyWaterHole.item(), "IBI", "B B",
                "IBI", 'B', "blockVanadium", 'I', "plateVanadium");
        ...
        // getUsualItemStack(new ItemStack(Blocks.tallgrass)),
        // ItemType.DrawingWaterPart.item(4), 20*20, 120);
        ...
        addShapelessRecipeByOreDictionary(
                ItemType.DrawingWaterComponent.item(), ItemMaterial.get(
                        MaterialTypes.VanadiumSteel, MaterialForms.ring),
                ItemType.DrawingWaterPart.item(),
                ItemType.DrawingWaterPart.item(),
                ItemType.DrawingWaterPart.item(),
                ItemType.DrawingWaterPart.item());
        ...
        if (!Mods.IndustrialCraft2.isAvailable) {
            RecipeAdder.macerator(new ItemStack(Items.diamond),
                    ItemType.DustDiamond.item());
            RecipeAdder.macerator(new ItemStack(Blocks.iron_ore),
                    ItemType.DustIron.item(2));
            RecipeAdder.macerator(new ItemStack(Blocks.gold_ore),
                    ItemType.DustGold.item(2));
            RecipeAdder.macerator(new ItemStack(Items.iron_ingot),
                    ItemType.DustIron.item());
            RecipeAdder.macerator(new ItemStack(Items.gold_ingot),
                    ItemType.DustGold.item());
            FurnaceRecipes.smelting().func_151394_a(ItemType.DustIron.item(),
                    new ItemStack(Items.iron_ingot), 0f);
            FurnaceRecipes.smelting().func_151394_a(ItemType.DustGold.item(),
                    new ItemStack(Items.gold_ingot), 0f);
        }

        OreDictionary.registerOre("plateDenseRedstone",
                ItemType.DenseRedstonePlate.item());
        RecipeAdder.compressor(new ItemStack(Blocks.redstone_block),
                ItemType.DenseRedstonePlate.item());
    }
    ...
    public void registerTurbine() {
        if (Mods.IndustrialCraft2.isAvailable)
            addRecipeByOreDictionary(ItemType.BaseRotor.item(), "ILI", "LCL",
                    "ILI", 'I', "plateDenseIron", 'L', "plateDenseLead", 'C',
                    carbonPlate);
        else
            addRecipeByOreDictionary(ItemType.BaseRotor.item(), "ILI", "LCL",
                    "ILI", 'I', "plateDenseSteel", 'L', "plateDenseZinc", 'C',
                    carbonPlate);
        ...
        addRecipeByOreDictionary(new ItemStack(GlobalBlocks.turbine, 1, 0),
                "SAU", "CGA", "SAU", 'S', Blocks.iron_bars, 'A', new ItemStack(
                        GlobalBlocks.waterMill, 1, 4), 'G',
                ItemType.ReservoirCore.item(), 'U', ItemType.MK1.item(), 'C',
                Blocks.glass_pane);
        addRecipeByOreDictionary(new ItemStack(GlobalBlocks.turbine, 1, 1),
        ...
        addRecipeByOreDictionary(new ItemStack(GlobalBlocks.turbine, 1, 2),
                ...
                IndustrialCraftModule.getIC2Item("advancedMachine"), 'R',
                ItemType.BaseRotor.item());
        addRecipeByOreDictionary(new ItemStack(GlobalBlocks.turbine, 1, 3),
                "IRI", "TCT", "IRI", 'T', new ItemStack(GlobalBlocks.turbine,
                        1, 2), 'I',
                IndustrialCraftModule.getIC2Item("reactorPlating"), 'C',
                IndustrialCraftModule.getIC2Item("teleporter"), 'R',
                ItemType.BaseRotor.item());
        // }
    ...
    public void registerMachines() {
        addRecipeByOreDictionary(GlobalBlocks.sawmill, " H ", "CPC", "KKK",
                'H', ItemType.WoodenHammer.item(), 'C',
                ItemCrafting.get(CraftingTypes.casing, LevelTypes.MK1), 'K',
                Blocks.stonebrick, 'P', ItemType.DiamondBlade.item());
        addRecipeByOreDictionary(GlobalBlocks.sawmill, " H ", "CPC", "KKK",
                'H', ItemType.WoodenHammer.item(), 'C',
                ItemCrafting.get(CraftingTypes.casing, LevelTypes.MK1), 'K',
                Blocks.stonebrick, 'P', Items.flint);
        addRecipeByOreDictionary(GlobalBlocks.macerator, " H ", "CPC", "KRK",
                'H', ItemType.WoodenHammer.item(), 'C',
                ItemCrafting.get(CraftingTypes.casing, LevelTypes.MK1), 'K',
                Blocks.stonebrick, 'P', ItemType.DiamondGlazingWheel.item(),
                'R', Blocks.hopper);
        addRecipeByOreDictionary(GlobalBlocks.macerator, " H ", "CPC", "KRK",
                'H', ItemType.WoodenHammer.item(), 'C',
                ItemCrafting.get(CraftingTypes.casing, LevelTypes.MK1), 'K',
                Blocks.stonebrick, 'P', Items.flint, 'R', Blocks.hopper);
        addRecipeByOreDictionary(GlobalBlocks.compressor, "CDC", "DGD", "ICA",
                'C', ItemCrafting.get(CraftingTypes.casing, LevelTypes.MK1),
                'D', "plateDenseIndustrialSteel", 'G',
                ItemType.IndustrialSteelHydraulicCylinder.item(), 'I',
                ItemCrafting.get(CraftingTypes.circuit, LevelTypes.MK1), 'A',
                ItemCrafting.get(CraftingTypes.circuit, LevelTypes.MK1));
        addRecipeByOreDictionary(GlobalBlocks.centrifuge, "CBC", "BRB", "XCX",
                'C', ItemCrafting.get(CraftingTypes.casing, LevelTypes.MK4),
                'B', ItemType.BrassCentrifugePot.item(), 'R',
                ItemCrafting.get(CraftingTypes.rotationAxle, LevelTypes.MK4),
                'X', ItemType.DataBall.item());
        addRecipeByOreDictionary(GlobalBlocks.cutter, "CPC", "SMS", "SSS", 'C',
                ItemCrafting.get(CraftingTypes.casing, LevelTypes.MK1), 'P',
                ItemType.VSteelWaterPipe.item(), 'M',
                ItemType.RubyWaterHole.item(), 'S', "plateManganese");
        addRecipeByOreDictionary(GlobalBlocks.cutter, "A", 'A',
                GlobalBlocks.lathe);
        addRecipeByOreDictionary(GlobalBlocks.lathe, "A", 'A',
                GlobalBlocks.cutter);
        addRecipeByOreDictionary(GlobalBlocks.advancedCompressor, "CDC", "CPC",
                "CIC", 'C',
                ItemCrafting.get(CraftingTypes.casing, LevelTypes.MK5), 'D',
                "plateDenseVanadiumSteel", 'P',
                ItemType.VSteelPistonCylinder.item(), 'I',
                ItemCrafting.get(CraftingTypes.circuit, LevelTypes.MK4));
    }
    ...
    public void registerPlugins() {
        ...
        addShapelessRecipeByOreDictionary(PluginType.AllRoundMK1.item(),
                PluginType.StorageMK1.item(), PluginType.RainMK1.item(),
                PluginType.OverMK1.item(), PluginType.UnderMK1.item());
        addShapelessRecipeByOreDictionary(PluginType.StorageMK1.item(),
                new ItemStack(GlobalBlocks.reservoir, 1, 8), Items.iron_ingot,
                Items.iron_ingot, Items.iron_ingot);
        addShapelessRecipeByOreDictionary(PluginType.StorageMK2.item(),
                new ItemStack(GlobalBlocks.reservoir, 1, 17),
                PluginType.StorageMK1.item(), Items.iron_ingot,
                Items.iron_ingot, Items.iron_ingot);
        addShapelessRecipeByOreDictionary(PluginType.SpeedMK1.item(),
                ItemType.DataBall.item(), Items.iron_ingot, Items.iron_ingot,
                Items.iron_ingot);
        addRecipeByOreDictionary(PluginType.OverMK1.item(), "CBC", "EPE",
                "CBC", 'C', ItemType.DrawingWaterComponent.item(), 'B',
                IndustrialCraftModule.getIC2Item("pump"), 'E',
                IndustrialCraftModule.getIC2Item("extractor"), 'P',
                ItemType.VSteelWaterPipe.item());
        addShapelessRecipeByOreDictionary(PluginType.UnderMK1.item(),
                PluginType.OverMK1.item());
        addShapelessRecipeByOreDictionary(PluginType.OverMK1.item(),
                PluginType.UnderMK1.item());
        addRecipeByOreDictionary(PluginType.RainMK1.item(), "C C", "EPE",
                "C C", 'C', ItemType.DrawingWaterComponent.item(), 'E',
                IndustrialCraftModule.getIC2Item("extractor"), 'P',
                ItemType.VSteelWaterPipe.item());
    }
