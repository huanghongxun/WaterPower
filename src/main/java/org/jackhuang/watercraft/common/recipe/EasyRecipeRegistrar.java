...
public class EasyRecipeRegistrar extends IRecipeRegistrar {
    ...
    public void registerWatermills() {
        addRecipeByOreDictionary(new ItemStack(GlobalBlocks.waterMill, 1, 0), "CUC", "SAS", "PMP", 'C', ICItemFinder.getIC2Item("FluidCell"), 'A', "blockIron", 'S', "plateIron", 'P', "circuitBasic", 'M', ItemType.MK0.item(), 'U', ItemType.WaterUraniumIngot.item());

        addRecipeByOreDictionary(new ItemStack(GlobalBlocks.waterMill, 1, 1), "CUC", "SAS", "PMP", 'C', ICItemFinder.getIC2Item("FluidCell"), 'A', new ItemStack(GlobalBlocks.waterMill, 1, 0), 'S', "plateIron", 'P', "circuitAdvanced", 'M', ItemType.MK0.item(), 'U', ItemType.WaterUraniumIngot.item());

        addRecipeByOreDictionary(new ItemStack(GlobalBlocks.waterMill, 1, 3), "CUC", "SAS", "PMP", 'C', ICItemFinder.getIC2Item("FluidCell"), 'A', new ItemStack(GlobalBlocks.waterMill, 1, 1), 'S', carbonPlate, 'P', "circuitAdvanced", 'M', ItemType.MK1.item(), 'U', ItemType.WaterUraniumPlateMK1.item());

        addRecipeByOreDictionary(new ItemStack(GlobalBlocks.waterMill, 1, 4), "CUC", "SAS", "PMP", 'C', ICItemFinder.getIC2Item("FluidCell"), 'A', new ItemStack(GlobalBlocks.waterMill, 1, 3), 'S', advancedAlloy, 'P', "circuitAdvanced", 'M', ItemType.MK2.item(), 'U', ItemType.WaterUraniumPlateMK2.item());

        addRecipeByOreDictionary(new ItemStack(GlobalBlocks.waterMill, 1, 5), "CUC", "SAS", "PMP", 'C', ICItemFinder.getIC2Item("FluidCell"), 'A', new ItemStack(GlobalBlocks.waterMill, 1, 4), 'S', ICItemFinder.getIC2Item("elemotor"), 'P', "circuitAdvanced", 'M', ItemType.MK2.item(), 'U', ItemType.WaterUraniumPlateMK2.item());

        addRecipeByOreDictionary(new ItemStack(GlobalBlocks.waterMill, 1, 6), "CUC", "SAS", "PMP", 'C', ICItemFinder.getIC2Item("FluidCell"), 'A', new ItemStack(GlobalBlocks.waterMill, 1, 5), 'S', getUsualItemStack(ICItemFinder.getIC2Item("lapotronCrystal")), 'P', "circuitAdvanced", 'M', ItemType.MK3.item(), 'U', ItemType.WaterUraniumPlateMK3.item());
    ...
    public void registerRange() {
        if (gregtechRecipe) {
            addRecipeByOreDictionary(new ItemStack(GlobalItems.range, 1, 0), "WSW", "SAS", "WSW", 'W', "circuitBasic", 'S', getUsualItemStack(ICItemFinder.getIC2Item("energyCrystal")), 'A', machine);
            addRecipeByOreDictionary(new ItemStack(GlobalItems.range, 1, 1), "WSW", "SAS", "WSW", 'W', "circuitAdvanced", 'S', getUsualItemStack(ICItemFinder.getIC2Item("lapotronCrystal")), 'A', new ItemStack(GlobalItems.range, 1, 0));
            addRecipeByOreDictionary(new ItemStack(GlobalItems.range, 1, 2), "WSW", "SAS", "WSW", 'W', getUsualItemStack(ICItemFinder.getIC2Item("energyCrystal")), 'S', ICItemFinder.getIC2Item("mfeUnit"), 'A', new ItemStack(GlobalItems.range, 1, 1));
            addRecipeByOreDictionary(new ItemStack(GlobalItems.range, 1, 3), "WSW", "SAS", "WSW", 'W', getUsualItemStack(ICItemFinder.getIC2Item("lapotronCrystal")), 'S', ICItemFinder.getIC2Item("mfsUnit"), 'A', new ItemStack(GlobalItems.range, 1, 2));
        } else {
            addRecipeByOreDictionary(new ItemStack(GlobalItems.range, 1, 0), "WSW", "SAS", "WSW", 'W', "circuitBasic", 'S', ICItemFinder.getIC2Item("batBox"), 'A', machine);
            addRecipeByOreDictionary(new ItemStack(GlobalItems.range, 1, 1), "WSW", "SAS", "WSW", 'W', "circuitAdvanced", 'S', ICItemFinder.getIC2Item("cesuUnit"), 'A', new ItemStack(GlobalItems.range, 1, 0));
            addRecipeByOreDictionary(new ItemStack(GlobalItems.range, 1, 2), "WSW", "SAS", "WSW", 'W', getUsualItemStack(ICItemFinder.getIC2Item("energyCrystal")), 'S', ICItemFinder.getIC2Item("mfeUnit"), 'A', new ItemStack(GlobalItems.range, 1, 1));
            addRecipeByOreDictionary(new ItemStack(GlobalItems.range, 1, 3), "WSW", "SAS", "WSW", 'W', getUsualItemStack(ICItemFinder.getIC2Item("lapotronCrystal")), 'S', ICItemFinder.getIC2Item("mfsUnit"), 'A', new ItemStack(GlobalItems.range, 1, 2));
        }
    }
    ...
    public void registerUpdater() {
        ...
        if (Mods.IndustrialCraft2.isAvailable)
            addRecipeByOreDictionary(ItemType.WaterUraniumPlateMK7.item(), "SSS", "SAS", "SSS", 'A', ItemType.WaterUraniumPlateMK6.item(), 'S', ICItemFinder.getIC2Item("iridiumPlate"));
        else
        ...
        addRecipeByOreDictionary(ItemType.MK0.item(), "SAS", "AGA", "SAS", 'S', advancedAlloy, 'A', ItemType.WaterUraniumPlateMK1.item(), 'G', transformerUpgrade);
        addRecipeByOreDictionary(ItemType.MK1.item(), "SMS", "UGU", "SAS", 'S', Items.redstone, 'U', ItemType.WaterUraniumPlateMK1.item(), 'A', "gemDiamond", 'M', "plateSteel", 'G', ItemType.MK0.item());
        addRecipeByOreDictionary(ItemType.MK2.item(), "SMS", "UGU", "SAS", 'S', advancedAlloy, 'U', ItemType.WaterUraniumPlateMK2.item(), 'A', carbonPlate, 'M', Blocks.lapis_block, 'G', ItemType.MK1.item());
        addRecipeByOreDictionary(ItemType.MK3.item(), "SMS", "UGU", "SAS", 'S', advancedAlloy, 'U', ItemType.WaterUraniumPlateMK3.item(), 'A', industrialDiamond, 'M', "gemDiamond", 'G', ItemType.MK2.item());
        addRecipeByOreDictionary(ItemType.IR_FE.item(), "SSS", "SGS", "SSS", 'S', iron, 'G', iridiumPlate);
        if (Mods.IndustrialCraft2.isAvailable) {
            addRecipeByOreDictionary(ItemType.MK4.item(), "SMS", "UGU", "SAS", 'S', ICItemFinder.getIC2Item("advancedAlloy"), 'U', ItemType.WaterUraniumPlateMK4.item(), 'A', getUsualItemStack(ICItemFinder.getIC2Item("advBattery")), 'M', Blocks.emerald_block, 'G', ItemType.MK3.item());
            addRecipeByOreDictionary(ItemType.MK5.item(), "SMS", "UGU", "SAS", 'S', ICItemFinder.getIC2Item("advancedAlloy"), 'U', ItemType.WaterUraniumPlateMK5.item(), 'A', getUsualItemStack(ICItemFinder.getIC2Item("energyCrystal")), 'M', doesOreNameExist("blockRuby") ? "blockRuby" : "blockManganeseSteel", 'G', ItemType.MK4.item());
            addRecipeByOreDictionary(ItemType.MK6.item(), "SMS", "UGU", "SAS", 'S', advancedAlloy, 'U', ItemType.WaterUraniumPlateMK6.item(), 'A', getUsualItemStack(ICItemFinder.getIC2Item("lapotronCrystal")), 'M', doesOreNameExist("blockSapphire") ? "blockSapphire" : "blockVanadium", 'G', ItemType.MK5.item());
            addRecipeByOreDictionary(ItemType.MK7.item(), "SMS", "UGU", "SAS", 'S', ICItemFinder.getIC2Item("advancedAlloy"), 'U', ItemType.WaterUraniumPlateMK7.item(), 'A', getUsualItemStack(ICItemFinder.getIC2Item("suBattery")), 'M', doesOreNameExist("blockChrome") ? "blockChrome" : "blockVanadiumSteel", 'G', ItemType.MK6.item());
        } else {
            ...
            addRecipeByOreDictionary(ItemType.MK5.item(), "SMS", "UGU", "SAS", 'S', "plateSteel", 'U', ItemType.WaterUraniumPlateMK5.item(), 'A', "stickVanadium", 'M', doesOreNameExist("blockRuby") ? "blockRuby" : "blockManganeseSteel", 'G', ItemType.MK4.item());
            addRecipeByOreDictionary(ItemType.MK6.item(), "SMS", "UGU", "SAS", 'S', "plateSteel", 'U', ItemType.WaterUraniumPlateMK6.item(), 'A', "stickNeodymium", 'M', doesOreNameExist("blockSapphire") ? "blockSapphire" : "blockVanadium", 'G', ItemType.MK5.item());
            addRecipeByOreDictionary(ItemType.MK7.item(), "SMS", "UGU", "SAS", 'S', "plateSteel", 'U', ItemType.WaterUraniumPlateMK7.item(), 'A', "NeodymiumMagnet", 'M', doesOreNameExist("blockChrome") ? "blockChrome" : "blockVanadiumSteel", 'G', ItemType.MK6.item());
        }

        addRecipeByOreDictionary(ItemType.ReservoirCore.item(), "ASA", "SMS", "CSC", 'A', "circuitBasic", 'S', advancedAlloy, 'M', machine, 'C', ItemType.WaterUraniumPlateMK1.item());
        if (Mods.IndustrialCraft2.isAvailable) {
            addRecipeByOreDictionary(ItemType.ReservoirCoreAdvanced.item(), "IDI", "AMA", "IDI", 'I', iridiumPlate, 'A', ICItemFinder.getIC2Item("advancedCircuit"), 'M', ItemType.ReservoirCore.item(), 'D', "gemDiamond");
        }
        ...
        addRecipeByOreDictionary(ItemType.WaterUraniumAlloyPlate.item(), "UIU", "IDI", "UIU", 'U', ItemType.WaterUraniumIngot.item(), 'I', iridiumPlate, 'D', "gemDiamond");

        addRecipeByOreDictionary(ItemType.PlasmaUraniumAlloyPlate.item(), "OPO", "PUP", "OPO", 'O', doesOreNameExist("plateOsmium") ? "plateOsmium" : "plateVanadium", 'P', ItemType.PlasmaUraniumIngot.item(), 'U', ItemType.WaterUraniumAlloyPlate.item());
        ...
        addRecipeByOreDictionary(ItemType.DataBall.item(), " D ", "CIC", " D ", 'D', Items.emerald, 'C', ItemCrafting.get(CraftingTypes.circuit, LevelTypes.MK1), 'I', "circuitBasic");
    ...
    public void registerTurbine() {
         ...
         * else {
         */
        addRecipeByOreDictionary(new ItemStack(GlobalBlocks.turbine, 1, 0), "SAU", "CGA", "SAU", 'S', Blocks.iron_bars, 'A', new ItemStack(GlobalBlocks.waterMill, 1, 4), 'G', ItemType.ReservoirCore.item(), 'U', ItemType.MK1.item(), 'C', Blocks.glass_pane);
        addRecipeByOreDictionary(new ItemStack(GlobalBlocks.turbine, 1, 1), "IUI", "TCT", "IRI", 'T', new ItemStack(GlobalBlocks.turbine, 1, 0), 'I', Mods.IndustrialCraft2.isAvailable ? "plateDenseIron" : "plateDenseSteel", 'U', transformerUpgrade, 'C', "circuitAdvanced", 'R', ItemType.BaseRotor.item());
        addRecipeByOreDictionary(new ItemStack(GlobalBlocks.turbine, 1, 2), "IUI", "TCT", "IRI", 'T', new ItemStack(GlobalBlocks.turbine, 1, 1), 'I', carbonPlate, 'U', "circuitAdvanced", 'C', ICItemFinder.getIC2Item("advancedMachine"), 'R', ItemType.BaseRotor.item());
        addRecipeByOreDictionary(new ItemStack(GlobalBlocks.turbine, 1, 3), "IRI", "TCT", "IRI", 'T', new ItemStack(GlobalBlocks.turbine, 1, 2), 'I', ICItemFinder.getIC2Item("reactorPlating"), 'C', ICItemFinder.getIC2Item("teleporter"), 'R', ItemType.BaseRotor.item());
        // }
    ...
    public void registerMachines() {
        addRecipeByOreDictionary(GlobalBlocks.sawmill, " H ", "CPC", "KKK", 'H', ItemType.WoodenHammer.item(), 'C', ItemCrafting.get(CraftingTypes.casing, LevelTypes.MK1), 'K', Blocks.stonebrick, 'P', ItemType.DiamondBlade.item());
        addRecipeByOreDictionary(GlobalBlocks.sawmill, " H ", "CPC", "KKK", 'H', ItemType.WoodenHammer.item(), 'C', ItemCrafting.get(CraftingTypes.casing, LevelTypes.MK1), 'K', Blocks.stonebrick, 'P', Items.flint);
        addRecipeByOreDictionary(GlobalBlocks.macerator, " H ", "CPC", "KRK", 'H', ItemType.WoodenHammer.item(), 'C', ItemCrafting.get(CraftingTypes.casing, LevelTypes.MK1), 'K', Blocks.stonebrick, 'P', ItemType.DiamondGlazingWheel.item(), 'R', Blocks.hopper);
        addRecipeByOreDictionary(GlobalBlocks.macerator, " H ", "CPC", "KRK", 'H', ItemType.WoodenHammer.item(), 'C', ItemCrafting.get(CraftingTypes.casing, LevelTypes.MK1), 'K', Blocks.stonebrick, 'P', Items.flint, 'R', Blocks.hopper);
    ...
    public void registerPlugins() {
        ...
        addShapelessRecipeByOreDictionary(PluginType.StorageMK1.item(), new ItemStack(GlobalBlocks.reservoir, 1, 8), Items.iron_ingot, Items.iron_ingot, Items.iron_ingot);
        addShapelessRecipeByOreDictionary(PluginType.StorageMK2.item(), new ItemStack(GlobalBlocks.reservoir, 1, 17), PluginType.StorageMK1.item(), Items.iron_ingot, Items.iron_ingot, Items.iron_ingot);
        ...
        if (Mods.IndustrialCraft2.isAvailable) {
            ...
            addRecipeByOreDictionary(PluginType.OverMK1.item(), "CBC", "EPE", "CBC", 'C', "ringVanadiumSteel", 'B', ICItemFinder.getIC2Item("pump"), 'E', extractor, 'P', ItemType.VSteelWaterPipe.item());
        }
        if (Mods.BuildCraftFactory.isAvailable) {
            addRecipeByOreDictionary(PluginType.OverMK1.item(), "CBC", "EPE", "CBC", 'C', "ringVanadiumSteel", 'B', GameRegistry.findBlock("BuildCraft|Factory", "pumpBlock"), 'E', ItemType.RubyWaterHole.item(), 'P', ItemType.VSteelWaterPipe.item());
        }
