...
public enum RotorType {
    ...
    public String getShowedName() {
        return StatCollector.translateToLocal("cptwtrml.reservoir." + name()) + ' ' + StatCollector.translateToLocal("cptwtrml.rotor.ROTOR");
    }
    ...
    public static void registerRotor() {
        ...
        addRotorRecipe(RotorType.OBSIDIAN, "plateObsidian", "plateDenseObsidian");
        addRotorRecipe(RotorType.BRONZE, "plateBronze", "plateDenseBronze");
        addRotorRecipe(RotorType.LAPIS, "plateLapis", "plateDenseLapis");
        addRotorRecipe(RotorType.QUARTZ, Items.quartz, Blocks.quartz_block);
        addRotorRecipe(RotorType.CARBON, ICItemFinder.getIC2Item("carbonPlate"), ICItemFinder.getIC2Item("coalChunk"));
        addRotorRecipe(RotorType.ADVANCED, ICItemFinder.getIC2Item("advancedAlloy"), ICItemFinder.getIC2Item("reinforcedStone"));
        ...
        addRotorRecipe(RotorType.IRIDIUM, ICItemFinder.getIC2Item("iridiumOre"), ICItemFinder.getIC2Item("iridiumPlate"));
        addRotorRecipe(RotorType.IRIDIUMIRON, ICItemFinder.getIC2Item("iridiumPlate"), ItemType.IR_FE.item());
        ...
        addRotorRecipe(RotorType.TUNGSTEN_STEEL, "plateTungstenSteel", "blockTungstenSteel");
        if (Mods.Thaumcraft.isAvailable) {
            addRotorRecipe(RotorType.THAUMIUM, ItemApi.getItem("itemNugget", 6), ItemApi.getBlock("blockCosmeticSolid", 4));
        }
    }
    ...
    static void addRotorRecipe(RotorType output, Object S, Object I) {
        if (S == null || I == null)
            return;
        if (output.enable) {
            IRecipeRegistrar.addRecipeByOreDictionary(new ItemStack(output.getItem()), "S S", " I ", "S S", 'S', S, 'I', I);
        }
    }
