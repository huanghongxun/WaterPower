...
public enum WaterType {
    MK1(1, 5), MK2(8, 5), MK3(32, 17), MK4(128, 17), MK5(512, 33), MK6(2048, 33), MK7(8192, 65), MK8(32768, 65), MK9(131072, 129), MK10(524288, 129), MK11(2097152, 255), MK12(8388608, 255), MK13(33554432, 513), MK14(134217728, 513), MK15(536870912, 1025), MK16(2147483647, 1025);
    ...
    public static TileEntityWatermill makeTileEntity(int metadata) {
        try {
            ...
            WPLog.warn("Failed to Register Watermill: " + WaterType.values()[metadata].name());
