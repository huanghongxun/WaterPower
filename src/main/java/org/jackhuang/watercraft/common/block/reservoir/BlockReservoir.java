...
public class BlockReservoir extends BlockRotor {
	...
	public void registerReservoir() {
		...
		addReservoirRecipe(new ItemStack(this, 8, 1), Block.stone);
		addReservoirRecipe(new ItemStack(this, 8, 2), Block.blockLapis);
		...
		addReservoirRecipe(new ItemStack(this, 8, 6), Block.blockNetherQuartz);
		addReservoirRecipe(new ItemStack(this, 8, 7), "blockBronze");
		addReservoirRecipe(new ItemStack(this, 8, 8), Block.blockIron);
		addReservoirRecipe(new ItemStack(this, 8, 9), Block.netherBrick);
		addReservoirRecipe(new ItemStack(this, 8, 10), Block.obsidian);
		addReservoirRecipe(new ItemStack(this, 8, 11), "blockSilver");
		addReservoirRecipe(new ItemStack(this, 8, 12), Block.blockGold);
