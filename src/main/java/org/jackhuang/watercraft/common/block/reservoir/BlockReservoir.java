...
public class BlockReservoir extends BlockMeta {
	...
	/* Zinc */
	addReservoirRecipe(new ItemStack(this, 8, 19), "blockZinc"); // GregTech_API.getGregTechBlock(4,
	// 1,
	// 2));
		/* Brass */
	addReservoirRecipe(new ItemStack(this, 8, 20), "blockBrass"); // GregTech_API.getGregTechBlock(0,
	// 1,
	// 12));
		/* Aluminum */
	...
	// 1, 11));
		/* Invar */
	addReservoirRecipe(new ItemStack(this, 8, 23), "blockInvar"); // GregTech_API.getGregTechBlock(4,
	// 1,
	// 10));
		/* Electrum */
