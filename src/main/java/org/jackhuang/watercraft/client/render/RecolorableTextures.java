...
public class RecolorableTextures {
    public static final IIconContainer[] METAL = { ItemIcons.PLATE, ItemIcons.DUST, ItemIcons.DUST_TINY, ItemIcons.DUST_SMALL, ItemIcons.PLATE_DENSE, ItemIcons.INGOT, ItemIcons.BLOCK, ItemIcons.STICK, ItemIcons.SCREW, ItemIcons.GEAR, ItemIcons.NUGGET, ItemIcons.RING };
