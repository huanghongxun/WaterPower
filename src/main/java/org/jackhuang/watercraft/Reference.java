...
public class Reference {
	...
	/**
	 * Get configs from file to set whatever generate ores.
	 *
	 * @param config
	 */
	...
	/**
	 * Get configs from file what is change percent.
	 *
	 * @param config
	 */
	static void initConfig(Configuration config) {
    ...
    /**
     * Set whatever does machine and rotor enabled.
     */
